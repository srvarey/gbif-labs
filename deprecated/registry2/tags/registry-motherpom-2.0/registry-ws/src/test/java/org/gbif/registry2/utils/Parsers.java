...
public class Parsers {
   ...
   * string is concatenating all content and inserts a space at every element or attribute start.
   *
   * @see org.gbif.registry2.ws.model.LegacyDatasetResponse
   */
   ...
   * string is concatenating all content and inserts a space at every element or attribute start.
   *
   * @see org.gbif.registry2.ws.model.LegacyOrganizationResponse
   */
   ...
   * string is concatenating all content and inserts a space at every element or attribute start.
   *
   * @see org.gbif.registry2.ws.model.LegacyEndpointResponse
   */
