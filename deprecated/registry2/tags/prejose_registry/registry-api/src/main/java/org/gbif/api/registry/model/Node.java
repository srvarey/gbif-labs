 ...
 */
public class Node implements NetworkEntity, Taggable, Contactable {
...
// @Size(min = 10, max = 100) // TODO
  ...
  public int hashCode() {
    return Objects.hashCode(key, title, alias, description, language, email, phone, homepage,
      logoUrl, address, city, province, country, postalCode, latitude, longitude, created, modified, deleted, tags,
      contacts);
  }
