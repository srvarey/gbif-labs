...
sleep 1
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z09 --zoom 9  --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z9_stdout.log &
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z10 --zoom 10 --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z10_stdout.log &
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z11 --zoom 11 --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z11_stdout.log &
sleep 1
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z12 --zoom 12 --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z12_stdout.log &
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z13 --zoom 13 --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z13_stdout.log &
nohup java -Xms256M -Xmx256M -jar ../lib/metrics-cli.jar DensityCube --messaging-queue-name density_map_z14 --zoom 14 --conf ../config/maps.yaml --log-config ../config/logback-maps.xml &> ../logs/maps_z14_stdout.log &
sleep 1
