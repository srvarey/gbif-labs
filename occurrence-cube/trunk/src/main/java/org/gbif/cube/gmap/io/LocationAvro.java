...
public class LocationAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LocationAvro\",\"namespace\":\"org.gbif.cube.gmap.io\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"lat\",\"type\":\"double\"},{\"name\":\"lng\",\"type\":\"double\"}]}");
  ...
  public static org.gbif.cube.gmap.io.LocationAvro.Builder newBuilder() {
    return new org.gbif.cube.gmap.io.LocationAvro.Builder();
  }
  
  /** Creates a new LocationAvro RecordBuilder by copying an existing Builder */
  public static org.gbif.cube.gmap.io.LocationAvro.Builder newBuilder(org.gbif.cube.gmap.io.LocationAvro.Builder other) {
    return new org.gbif.cube.gmap.io.LocationAvro.Builder(other);
  }
  
  /** Creates a new LocationAvro RecordBuilder by copying an existing LocationAvro instance */
  public static org.gbif.cube.gmap.io.LocationAvro.Builder newBuilder(org.gbif.cube.gmap.io.LocationAvro other) {
    return new org.gbif.cube.gmap.io.LocationAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LocationAvro>
    ...
    private Builder() {
      super(org.gbif.cube.gmap.io.LocationAvro.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.gbif.cube.gmap.io.LocationAvro.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing LocationAvro instance */
    private Builder(org.gbif.cube.gmap.io.LocationAvro other) {
            super(org.gbif.cube.gmap.io.LocationAvro.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public org.gbif.cube.gmap.io.LocationAvro.Builder setId(int value) {
    ...
    public org.gbif.cube.gmap.io.LocationAvro.Builder clearId() {
    ...
    /** Sets the value of the 'lat' field */
    public org.gbif.cube.gmap.io.LocationAvro.Builder setLat(double value) {
    ...
    public org.gbif.cube.gmap.io.LocationAvro.Builder clearLat() {
    ...
    /** Sets the value of the 'lng' field */
    public org.gbif.cube.gmap.io.LocationAvro.Builder setLng(double value) {
    ...
    public org.gbif.cube.gmap.io.LocationAvro.Builder clearLng() {
