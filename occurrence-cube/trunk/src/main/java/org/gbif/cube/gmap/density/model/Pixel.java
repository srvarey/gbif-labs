...
public class Pixel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.gbif.cube.gmap.density.model.Pixel.Builder newBuilder() {
    return new org.gbif.cube.gmap.density.model.Pixel.Builder();
  }
  
  /** Creates a new Pixel RecordBuilder by copying an existing Builder */
  public static org.gbif.cube.gmap.density.model.Pixel.Builder newBuilder(org.gbif.cube.gmap.density.model.Pixel.Builder other) {
    return new org.gbif.cube.gmap.density.model.Pixel.Builder(other);
  }
  
  /** Creates a new Pixel RecordBuilder by copying an existing Pixel instance */
  public static org.gbif.cube.gmap.density.model.Pixel.Builder newBuilder(org.gbif.cube.gmap.density.model.Pixel other) {
    return new org.gbif.cube.gmap.density.model.Pixel.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Pixel>
    ...
    private Builder() {
      super(org.gbif.cube.gmap.density.model.Pixel.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.gbif.cube.gmap.density.model.Pixel.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Pixel instance */
    private Builder(org.gbif.cube.gmap.density.model.Pixel other) {
            super(org.gbif.cube.gmap.density.model.Pixel.SCHEMA$);
    ...
    /** Sets the value of the 'x' field */
    public org.gbif.cube.gmap.density.model.Pixel.Builder setX(int value) {
    ...
    public org.gbif.cube.gmap.density.model.Pixel.Builder clearX() {
    ...
    /** Sets the value of the 'y' field */
    public org.gbif.cube.gmap.density.model.Pixel.Builder setY(int value) {
    ...
    public org.gbif.cube.gmap.density.model.Pixel.Builder clearY() {
    ...
    /** Sets the value of the 'count' field */
    public org.gbif.cube.gmap.density.model.Pixel.Builder setCount(int value) {
    ...
    public org.gbif.cube.gmap.density.model.Pixel.Builder clearCount() {
