...
import org.gbif.registry2.utils.Parsers;
import org.gbif.registry2.utils.Requests;
...
public class LegacyOrganizationResourceIT {
  ...
  public void testGetOrganizationCallback() throws IOException, URISyntaxException, SAXException {
    ...
    // construct request uri
    String uri =
      Requests.getRequestUri("/registry/organisation/" + organization.getKey().toString() + ".json?callback=?");
  ...
  public void testGetOrganizationLogin() throws IOException, URISyntaxException, SAXException {
    ...
    // send GET request with no credentials, but no form encoded parameters
