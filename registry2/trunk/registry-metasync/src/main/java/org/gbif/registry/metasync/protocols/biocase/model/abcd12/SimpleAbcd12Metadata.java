...
public class SimpleAbcd12Metadata {
  ...
  @BeanPropertySetter(pattern = BASE_PATH
                                + "DatasetDerivations/DatasetDerivation/Supplier/TelephoneNumbers/TelephoneNumber/Number")
  private String phone;
  @BeanPropertySetter(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/TermsOfUse")
  private String rights;
  @BeanPropertySetter(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Statements/Acknowledgement")
  ...
  public void addTermsOfUse(
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/TermsOfUse") String termsOfUse
  ) {
  ...
  public void addIprDeclaration(
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/IPRDeclaration") String iprDeclaration
  ) {
  ...
  public void addRightsUrl(
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/RightsURL") String iprDeclaration
  ) {
  ...
  public void addOrganisationName(
    @CallParam(pattern = BASE_PATH + "DatasetDerivation/Supplier/OrganisationName") String iprDeclaration
  ) {
  ...
  public void addSupplierUrl(
    @CallParam(pattern = BASE_PATH + "DatasetDerivation/Supplier/URLs/URL") String iprDeclaration
  ) {
  ...
  public void addTechnicalContact(
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Supplier/Person/PersonName") String name,
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Supplier/EmailAddresses/EmailAddress")
    String email,
    @CallParam(pattern = BASE_PATH
                         + "DatasetDerivations/DatasetDerivation/Supplier/TelephoneNumbers/TelephoneNumber/Number")
    String phone,
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Supplier/Addresses/Address") String address
  ) {
  ...
  public void addAdministrativeContact(
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/LegalOwner/Person/PersonName")
    String name,
    @CallParam(pattern = BASE_PATH
    ...
    String phone,
    @CallParam(pattern = BASE_PATH + "DatasetDerivations/DatasetDerivation/Rights/LegalOwner/Addresses/Address")
    String address
  ) {
    Contact contact = new Contact();
    contact.setFirstName(name);
