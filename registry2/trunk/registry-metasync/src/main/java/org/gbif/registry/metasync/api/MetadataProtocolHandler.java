...
public interface MetadataProtocolHandler {
  ...
  /**
   * Determines if this handler does support the Installation in question. If it returns {@code true} then {@link
   * #syncInstallation(Installation, List)} installation will be called with the {@link Installation}.
   */
