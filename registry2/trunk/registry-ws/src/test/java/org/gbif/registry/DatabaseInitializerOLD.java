 ...
 * Renamed and indicated as deprecated, until presented to the Dev team.
 */
@Deprecated
class DatabaseInitializerOLD<T> extends DatabaseDrivenTestRule<T> {

  public DatabaseInitializerOLD() {
    super(
