...
@Path("installation")
@Singleton
public class InstallationResource extends AbstractNetworkEntityResource<Installation>
  implements InstallationService, ContactRest, EndpointRest, MachineTagRest, CommentRest, TagRest {
