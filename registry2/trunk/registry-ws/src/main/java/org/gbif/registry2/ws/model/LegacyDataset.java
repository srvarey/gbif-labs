...
public class LegacyDataset extends Dataset {
  ...
  private static Set<String> ARCHIVE_ENDPOINT_TYPE_ALTERNATIVES = ImmutableSet
    .of(LegacyResourceConstants.CHECKLIST_SERVICE_TYPE_1, LegacyResourceConstants.CHECKLIST_SERVICE_TYPE_2,
      LegacyResourceConstants.OCCURRENCE_SERVICE_TYPE_1, LegacyResourceConstants.OCCURRENCE_SERVICE_TYPE_2);
  ...
  public void setOrganizationKey(String organizationKey) {
    try {
      this.setOwningOrganizationKey(UUID.fromString(Strings.nullToEmpty(organizationKey)));
  ...
  public void setIptKey(String iptKey) {
    ...
    try {
      this.setInstallationKey(UUID.fromString(Strings.nullToEmpty(iptKey)));
    } catch (IllegalArgumentException e) {
  ...
  private Contact addPrimaryContact() {
    ...
    if (!Strings.isNullOrEmpty(primaryContactEmail) && getPrimaryContactType() != null) {
      ...
      contact.setAddress(getPrimaryContactAddress());
      contact.setDescription(getPrimaryContactDescription());
  ...
  private void addEmlEndpoint() {
    if (!Strings.isNullOrEmpty(getServiceUrls()) && !Strings.isNullOrEmpty(getServiceTypes())) {
      // create tokenizers
      StringTokenizer serviceTypesTokenizer = new StringTokenizer(getServiceTypes(), "|");
      StringTokenizer serviceUrlsTokenizer = new StringTokenizer(getServiceUrls(), "|");
      // find EML service
  ...
  public DatasetType resolveType() {
    if (getServiceTypes() != null) {
      if (getServiceTypes().contains(LegacyResourceConstants.CHECKLIST_SERVICE_TYPE_1) || getServiceTypes()
        .contains(LegacyResourceConstants.CHECKLIST_SERVICE_TYPE_2)) {
        return DatasetType.CHECKLIST;
      } else if (getServiceTypes().contains(LegacyResourceConstants.OCCURRENCE_SERVICE_TYPE_1) || getServiceTypes()
        .contains(LegacyResourceConstants.OCCURRENCE_SERVICE_TYPE_2)) {
