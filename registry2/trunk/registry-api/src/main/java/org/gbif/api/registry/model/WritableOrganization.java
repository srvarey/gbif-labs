 ...
 * 
 */
public class WritableOrganization implements WritableNetworkEntity {
...
// @Size(min = 10, max = 100) // TODO
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(key, endorsingNodeKey, endorsementApproved, title, alias, description, language, email,
      phone, homepage, logoUrl, address, city, province, country, postalCode, latitude, longitude);
  }

  @Override
  public boolean equals(Object object) {
    if (object instanceof WritableOrganization) {
      WritableOrganization that = (WritableOrganization) object;
