package models.occurrence.harvest.util;
...
public class TemplateUtils {
	...
	static {
		try {
			InputStream velPropsIS = TemplateUtils.class.getClassLoader().getResourceAsStream("models/occurrence/harvest/resources/velocity.properties");
