package models.occurrence.harvest.tapir;
...
import models.occurrence.harvest.dataaccess.*;
import models.*;
import models.occurrence.harvest.util.*;
...
public class Harvester extends models.occurrence.harvest.Harvester   
{
  ...
  private String templateLocation = "models/occurrence/harvest/resources/template/tapir/search.vm";
 ...
 * @throws SQLException 
  ...
  { 
	for (Dataset dataset : datasets)
    {
    	...
    	{
			LOG.info("Tapir Harvester is started");
